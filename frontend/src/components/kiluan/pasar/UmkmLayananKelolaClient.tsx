...
export default function UmkmLayananKelolaClient({ desaSlug, desaNama, awal }: Props) {
  const t = useTranslations('pasar.umkmLayanan')
    ...
    <div className="pb-16">
      ...
      <div className="container py-8">
        {isLoading ? (
          ...
          <KelolaLayananClient desaSlug={desaSlug} awal={awal} mode="pemilik" penyediaId={user.id} />
        )}
      </div>
    </div>
  )
