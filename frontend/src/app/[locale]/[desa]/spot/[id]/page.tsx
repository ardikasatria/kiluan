...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return metadataDesa({
    judul: detail?.nama ?? t('seoFallback'),
    desaSlug: desa,
    ...
    <div className="pb-20">
      ...
      <div className="container mt-10 grid gap-10 lg:grid-cols-3 lg:gap-12">
        <div className="space-y-8 lg:col-span-2">
          {detail.deskripsi && (
            <section>
              <SectionHeading icon={MapPinIcon}>{t('about')}</SectionHeading>
          ...
          {detail.lokasi && (
            <section>
              <SectionHeading icon={MapPinIcon}>{t('location')}</SectionHeading>
              <div className="mt-4">
          ...
          {detail.layanan.length > 0 && (
            <section>
              <SectionHeading icon={BanknotesIcon}>{t('services')}</SectionHeading>
          ...
          {detail.kalender.length > 0 && (
            <section>
              <SectionHeading icon={CalendarDaysIcon}>{t('schedule')}</SectionHeading>
              <ul className="mt-4 space-y-3">
