...
class JenisPeristiwaAnalitik(str, Enum):
...
METRIK_PKM = frozenset({
    KodeMetrik.pendapatan,
    KodeMetrik.kunjungan,
    KodeMetrik.kontribusi,
    KodeMetrik.umkm_aktif,
    KodeMetrik.adopsi_regeneratif,
    KodeMetrik.booking_per_tingkat,
})
